					...
					<view class="content--wrap_form">
						<view class="content--wrap_form_li">
							...
							<view class="content--wrap_form_li_right">															
								<input class="text2 input"  type="text" v-model="wxys.djbh" disabled/>
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
								<text class="text1">报修编号</text>
							</view>
							<view class="content--wrap_form_li_right">															
								<input class="text2 input"  type="text" v-model="wxys.bxdh" disabled/>
							</view>
						</view>						
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
						...
						<view class="content--wrap_form_li">
							...
							<view class="content--wrap_form_li_right">
								<input class="text2 input" type="text" v-model="wxys.ggxh" disabled/>
							</view>
						</view>
						...
						<view class="content--wrap_form_li">
							...
							<view class="content--wrap_form_li_right">
								<input class="text2 input" type="text" v-model="wxys.bgr" disabled/>						
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
							...
							<view class="content--wrap_form_li_right">
								<input class="text2 input" type="text" v-model="wxys.xcwxr" disabled/>						
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
							...
							<view class="content--wrap_form_li_right">
								<input class="text2 input" type="text" v-model="wxys.xcqkms" disabled/>						
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
							...
							<view class="content--wrap_form_li_right">
								<input class="text2 input" type="text" v-model="wxys.wxjgqr" disabled/>						
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
							...
							<view class="content--wrap_form_li_right">
								<input class="text2 input" type="text" v-model="wxys.qrr" disabled/>						
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
							...
							<view class="content--wrap_form_li_right">
								<picker class="text2" mode="date" :value="qrsjIndex" :start="startDate" :end="endDate" @change="bindqrsjChange" disabled>
									<view class="uni-input">{{wxys.qrsj}}</view>
								</picker> 							 
								<uni-icon class="icon" type="arrowright" size="20"></uni-icon>
							</view>
						</view>						
						<view class="content--wrap_form_li">
							...
							<view class="content--wrap_form_li_right">
								<input class="text2 input" type="text" v-model="wxys.bz" disabled/>
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
							...
							<view class="content--wrap_form_li_right">
								<input class="text2 input" type="text" v-model="wxys.tbr" disabled/>
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
							...
							<view class="content--wrap_form_li_right">
								<picker class="text2" mode="date" :value="tbsjIndex" :start="startDate" :end="endDate" @change="bindtbsjChange" disabled>
									<view class="uni-input">{{wxys.tbsj}}</view>
								</picker>
								<uni-icon class="icon" type="arrowright" size="20"></uni-icon>
							</view>
						</view>
						<view class="content--wrap_form_li">
							...
							<view class="content--wrap_form_li_right">
								<input class="text2 input" type="text" v-model="wxys.tbdw" disabled/>
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
							...
							<view class="content--wrap_form_li_right">
								<input class="text2 input" type="text" v-model="wxys.tbbm" disabled/>
							</view>
						</view>						
					</view>										
				</view>
...
<script>	
    ...
    export default {
		...
		onLoad:function(e){			
			let id = e.djbh			
			this.$api.getWxysInfoByID(id).then(res =>{
				if(res.data.code === 1){
					this.wxys = res.data.data
					 console.log(this.wxys)
				}else{
					uni.showToast({
						title:'详情查询失败'
					})
		...
		methods:{			
			...
			bindyqxfrqChange: function(e) {
				...
				this.wxys.yqxfrq = e.target.value				
			},
			...
			bindgzlxChange: function(e) {				
			    ...
			    this.wxys.gzlx = this.gzlxList[e.target.value]					
			},
