			...
			<view class="subPage--content">
				<view class="subPage--content--wrap">
					<view  class="content--wrap_form">
						<view class="content--wrap_form_li">
							...
							<view class="content--wrap_form_li_right">							
								...
								<input class="text2 input"  type="text" placeholder="请填写" v-model="jczb.htbh"/>
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
							...
							<view class="content--wrap_form_li_right">															
								<input class="text2 input"  type="text" placeholder="请填写" v-model="jczb.htje"/>
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
							...
							<view class="content--wrap_form_li_right">															
								<input class="text2 input"  type="text" placeholder="请填写" v-model="jczb.htmc"/>
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
							...
							<view class="content--wrap_form_li_right">															
								<input class="text2 input"  type="text" placeholder="请填写" v-model="jczb.sgdw"/>
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
							...
							<view class="content--wrap_form_li_right">															
								<input class="text2 input"  type="text" placeholder="请填写" v-model="jczb.gldw"/>
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
							...
							<view class="content--wrap_form_li_right">								
								<input class="text2 input"  type="text" placeholder="请填写" v-model="jczb.jcr"/>
							</view>
						</view>
							<view class="content--wrap_form_li">
								<view class="content--wrap_form_li_left">
						...
						<view class="content--wrap_form_li">
							...
							<view class="content--wrap_form_li_right">
								...
								<input class="text2 input"  type="text" placeholder="请填写" v-model="jczb.wyfj"/>
							</view>
						</view>
						<view class="content--wrap_form_li">
							<view class="content--wrap_form_li_left">
							...
							<view class="content--wrap_form_li_right">
								<input class="text2 input"  type="text" placeholder="请填写" v-model="jczb.bz"/>
							</view>
						</view>																		
					</view>
					<!-- 检查项 -->
					<view class="subPage--content-bottomhalf-innerwrap-li-content-detail">											
						...
						v-for="(mx,index) in jczb.jczbmxb" 
						:key="index"
						>
...
<script>
    ...
    export default {
		...
		methods:{			
			...
			// 添加后保存
			onSave(){								
				this.$api.addJczb(this.jczb).then(res =>{
					if(res.data.code === 1){
						uni.showToast({
							title:'保存成功'
						})
